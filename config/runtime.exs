...
#
#     PHX_SERVER=true bin/anonychat start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :anonychat, AnonychatWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  rabbitmq_url =
    System.get_env("RABBITMQ_URL") ||
      ...
      For example: amqp://USER:PASS@HOST:PORT
      """

  config :anonychat, :amqp,
    connections: [
      chat_conn: [url: rabbitmq_url]
    ]
  ...
  #
  #     config :anonychat, Anonychat.Mailer,
